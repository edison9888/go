...
//                                             httpMethod:@"GET"];
//    
//    GTDoubanLoginViewController *doubanLoginViewController = [[GTDoubanLoginViewController alloc] initWithRequestURL:urlString];
//    doubanLoginViewController.delegate = self;
//    
//    ChufabaAppDelegate *chufabaDelegate = (ChufabaAppDelegate *)[UIApplication sharedApplication].delegate;
//    [chufabaDelegate.loginViewController.navigationController pushViewController:doubanLoginViewController animated:YES];
//}
...
- (void)startAuthorize {
    ...
    GTDoubanLoginViewController *doubanLoginViewController = [[GTDoubanLoginViewController alloc] initWithRequestURL:urlString];
    doubanLoginViewController.delegate = self;
    UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController:doubanLoginViewController];
